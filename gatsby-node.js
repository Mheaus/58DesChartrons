...
exports.createPages = ({ graphql, boundActionCreators }) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    //
    // Flat is a data node type derived from data/flats.json
    // which is created when scraping Instagram. “allFlatsJson”
      ...
      graphql(
        ...
        _.each(result.data.allFlatsJson.edges, edge => {
          ...
          createPage({
            ...
            path: `/flats/${slug(edge.node.id)}/`,
            component: slash(flatTemplate),
            context: {
              id: edge.node.id,
              directoryName: `/${edge.node.imagesDirectory}/g`,
            },
          })
        })
